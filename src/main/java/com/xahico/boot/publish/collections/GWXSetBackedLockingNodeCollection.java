...
**/
public class GWXSetBackedLockingNodeCollection <T extends GWXObject> extends GWXSetBackedNodeCollection<T> {
	public GWXSetBackedLockingNodeCollection (final Set<T> backing){
		super(backing);
	}
	
	public GWXSetBackedLockingNodeCollection (final GWXObject owner, final Set<T> backing){
		super(owner, backing);
	}
